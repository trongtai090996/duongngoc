...
public interface APIService {
    ...
    Call<String> getThemDonHang (@Field("idtaikhoan") int idtaikhoan, @Field("ngaydat") String ngaydat, @Field("diadiemgiaohang") String diadiemgiaohang);
    ...
    Call<String> postThemMonAn (@Field("iddanhmuc") int iddanhmuc,@Field("tenmonan") String tenmonan,@Field("gia") int gia,
                                @Field("tinhtrang") String tinhtrang,@Field("soluong") int soluong,
    ...
    Call<String> postSuaMonAn (@Field("idmonan") int idmonan,@Field("iddanhmucmoi") int iddanhmucmoi,@Field("tenmoi") String tenmoi,
                                @Field("tinhtrangmoi") String tinhtrangmoi,@Field("soluongmoi") int soluongmoi,

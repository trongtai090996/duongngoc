...
public class SuaMonAnActivity extends AppCompatActivity {
    EditText edtsuatenmonanquanli,edtsuamotamonanquanli,edtsuagiamonanquanli,edtsuasoluongmonanquanli,edtsualinkanhmonanquanli;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtsuasoluongmonanquanli.setText(""+soluong);
        ...
        btsuamonan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String soluongmoi=edtsuasoluongmonanquanli.getText().toString();
                ...
                if (tenmoi.equals("")==false && giamoi.equals("")==false && anhmoi.equals("")==false && soluongmoi.equals("")==false && motamoi.equals("")==false){
                    Retrofit retrofit = new Retrofit.Builder()
                            .baseUrl(Sever.BASE_URL)
                            .addConverterFactory(GsonConverterFactory.create())
                            .build();
                    APIService apiService = retrofit.create(APIService.class);
                    int soluongnew=Integer.parseInt(soluongmoi);
                    int gianew=Integer.parseInt(giamoi);
                    Call<String> call1=apiService.postSuaMonAn(idmonan,iddanhmucnew,tenmoi,tinhtrangmoi,soluongnew,anhmoi,motamoi,gianew);
    ...
    private void Anhxa() {
        ...
        edtsuasoluongmonanquanli=findViewById(R.id.edtsuasoluongmonanquanli);

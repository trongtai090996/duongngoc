...
public class DonHangAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, final ViewGroup viewGroup) {
        ...
        TextView tvphishipdonhang=(TextView) view.findViewById(R.id.tvphishipdonhang);
        ...
        call.enqueue(new Callback<Integer>() {
            ...
            public void onResponse(Call<Integer> call, Response<Integer> response) {
                ...
                int phiship=(int)donHang.getPhiship();
        ...
        tvphishipdonhang.setText((int)donHang.getPhiship()+" đ");
        ...
        bthuydonhang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (donHang.getTinhtrangdonhang().equals("Khách đã nhận hàng")==true || donHang.getTinhtrangdonhang().equals("Đang giao hàng")==true){
                    Toast.makeText(context,"Không thể hủy đơn hàng trong tình trạng đang giao hàng hoặc khách đã nhận hàng",Toast.LENGTH_LONG).show();
                }else {
                    final AlertDialog.Builder alertDialog =new AlertDialog.Builder(context);
                    alertDialog.setTitle("Thông báo");
                    alertDialog.setMessage("Bạn có muốn xóa đơn đặt món ăn có mã: "+donHang.getIddonhang()+" không?");
